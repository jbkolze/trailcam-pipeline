...
from trailcam_pipeline.models import Config, EventSummary, ValidationErrorReport
...
def run_pipeline(
    config: Config,
) -> tuple[list[EventSummary], list[ValidationErrorReport]]:
    ...
    return summarize_events(events), validation_errors
